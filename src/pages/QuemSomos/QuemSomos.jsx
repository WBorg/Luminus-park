...
import foto from 'assets/img/quemsomos.png';
    ...
    return ( 
        <>
            ...
            <div className={quemSomosCss.text}>
                ...
                <h2 className={quemSomosCss.title}>Missão</h2>
                ...
                <h2 className={quemSomosCss.title}>Visão</h2>
                ...
                <h2 className={quemSomosCss.title}>Valores</h2>
